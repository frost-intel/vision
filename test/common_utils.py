...
def cpu_and_cuda_and_xpu():
    return cpu_and_cuda() + (pytest.param("xpu", marks=pytest.mark.needs_xpu),)
...
def cpu_and_cuda_and_mps_and_xpu():
    return cpu_and_cuda_and_mps() + (pytest.param("xpu", marks=pytest.mark.needs_xpu),)
